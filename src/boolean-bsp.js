// BoxLab v0.36.18.214 — general sequential Boolean BSP kernel.
// Closed manifold meshes -> robust polygon triangulation -> BSP CSG -> welded editable mesh.
...
function assemble(polygons,eps){
  ...
  for(const poly of polygons){
    const points=cleanLoop(poly.vertices.map(v=>v.pos),tol*.25);if(points.length<3)continue;
