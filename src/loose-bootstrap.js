...
import { installSubdFriendlyBridge } from './bridge-all-quad.js?v=0.36.18.289';
...
import { installOpenChainAllQuadBridge } from './bridge-open-chain-all-quad.js?v=0.36.18.289';
