...
function finish(event){
  ...
  if(event.type==='pointerup'&&!d.changed){
    ...
    const remaining=d.faces.filter(index=>index!==d.hitFaceIndex);
    bridge()?.set?.('face',remaining);
    updateStatus();
