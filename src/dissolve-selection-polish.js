// BoxLab v0.36.18.24 — Dissolve result-selection polish.
// Keeps the stable dissolve topology unchanged. This module only owns the
// single-edge and closed-loop button commit path so useful surviving edges
// remain selected after the topology operation.
...
globalThis.__boxlabDissolveSelectionPolish={version:'0.36.18.24'};
