// BoxLab v0.36.18.315 — Clean for SubD with bounded thirty-four-triangle local retopo.

import { quadCleanMesh } from './quad-clean-core.js?v=0.36.18.315';
...
button?.addEventListener('click',()=>{
  ...
  manager()?.saveActive?.();
  globalThis.__boxlabQuadCleanLastResult={version:'0.36.18.315',workflow:'clean-for-subd',...result};
  if(result.changed){
    const parts=[];
