// BoxLab v0.36.18.311 — Clean for SubD with bounded twenty-eight-triangle local retopo.

import { quadCleanMesh } from './quad-clean-core.js?v=0.36.18.311';
...
button?.addEventListener('click',()=>{
  ...
  manager()?.saveActive?.();
  globalThis.__boxlabQuadCleanLastResult={version:'0.36.18.311',workflow:'clean-for-subd',...result};
  if(result.changed){
    const parts=[];
