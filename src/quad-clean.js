// BoxLab v0.36.18.302 — Clean for SubD with bounded ten-triangle local retopo.

import { quadCleanMesh } from './quad-clean-core.js?v=0.36.18.302';
...
button?.addEventListener('click',()=>{
  ...
  manager()?.saveActive?.();
  globalThis.__boxlabQuadCleanLastResult={version:'0.36.18.302',workflow:'clean-for-subd',...result};
  if(result.changed){
    const parts=[];
