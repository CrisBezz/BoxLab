// BoxLab v0.36.18.309 — Clean for SubD with bounded twenty-four-triangle local retopo.

import { quadCleanMesh } from './quad-clean-core.js?v=0.36.18.309';
...
button?.addEventListener('click',()=>{
  ...
  manager()?.saveActive?.();
  globalThis.__boxlabQuadCleanLastResult={version:'0.36.18.309',workflow:'clean-for-subd',...result};
  if(result.changed){
    const parts=[];
