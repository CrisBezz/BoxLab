// BoxLab v0.36.18.322 — Clean for SubD with worst-local internal-flow-aware patch ranking.

import { quadCleanMesh } from './quad-clean-core.js?v=0.36.18.322';
...
button?.addEventListener('click',()=>{
  ...
  manager()?.saveActive?.();
  globalThis.__boxlabQuadCleanLastResult={version:'0.36.18.322',workflow:'clean-for-subd',...result};
  if(result.changed){
    const parts=[];
