// BoxLab v0.36.18.129 — non-destructive Vertex valence / SubD inspection.
...
function stampVersion(){
  ...
  if(version)version.textContent='v0.36.18.129';
  document.title='BoxLab v0.36.18.129';
}
...
globalThis.__boxlabSelectVertexValence={version:'0.36.18.129',inspect,apply};
