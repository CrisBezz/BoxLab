// BoxLab v0.36.18.127 — non-destructive Vertex valence / SubD inspection.
...
function stampVersion(){
  ...
  if(version)version.textContent='v0.36.18.127';
  document.title='BoxLab v0.36.18.127';
}
...
globalThis.__boxlabSelectVertexValence={version:'0.36.18.127',inspect,apply};
