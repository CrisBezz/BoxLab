// BoxLab v0.36.18.123 — non-destructive Vertex valence / SubD inspection.
...
function stampVersion(){
  ...
  if(version)version.textContent='v0.36.18.123';
  document.title='BoxLab v0.36.18.123';
}
...
globalThis.__boxlabSelectVertexValence={version:'0.36.18.123',inspect,apply};
