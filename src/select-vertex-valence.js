// BoxLab v0.36.18.124 — non-destructive Vertex valence / SubD inspection.
...
function stampVersion(){
  ...
  if(version)version.textContent='v0.36.18.124';
  document.title='BoxLab v0.36.18.124';
}
...
globalThis.__boxlabSelectVertexValence={version:'0.36.18.124',inspect,apply};
