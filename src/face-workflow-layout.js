...
import './select-sharp-edges.js?v=0.36.18.125';
import './select-vertex-classification.js?v=0.36.18.115';
import './select-vertex-valence.js?v=0.36.18.125';
import './select-quads.js?v=0.36.18.124';

// BoxLab v0.36.18.125 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.125',sync};
