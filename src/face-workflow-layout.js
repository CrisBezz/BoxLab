...
import './face-repair-drawer.js?v=0.36.18.139';
import './release-version.js?v=0.36.18.139';

// BoxLab v0.36.18.139 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.139',sync};
