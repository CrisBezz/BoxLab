...
import './release-version.js?v=0.36.18.144';

// BoxLab v0.36.18.144 — Face workflow layout polish + on-demand Mesh Health.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.144',sync};
