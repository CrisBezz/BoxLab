...
import './select-vertex-valence.js?v=0.36.18.131';
import './select-quads.js?v=0.36.18.128';

// BoxLab v0.36.18.131 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.131',sync};
