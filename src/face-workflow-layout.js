...
import './release-version.js?v=0.36.18.149';

// BoxLab v0.36.18.149 — Face workflow layout polish + Add Vertex capture priority release advance.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.149',sync};
