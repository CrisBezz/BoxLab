...
import './release-version.js?v=0.36.18.145';

// BoxLab v0.36.18.145 — Face workflow layout polish + startup reveal.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.145',sync};
