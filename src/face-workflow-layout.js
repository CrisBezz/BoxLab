...
import './release-version.js?v=0.36.18.143';

// BoxLab v0.36.18.143 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.143',sync};
