...
import './release-version.js?v=0.36.18.156.1';

// BoxLab v0.36.18.156.1 — Add-session handoff hotfix release advance.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.156.1',sync};
