...
import './face-repair-drawer.js?v=0.36.18.142';
import './release-version.js?v=0.36.18.142';

// BoxLab v0.36.18.142 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.142',sync};
