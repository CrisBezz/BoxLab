...
import './select-sharp-edges.js?v=0.36.18.111';

// BoxLab v0.36.18.111 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.111',sync};
