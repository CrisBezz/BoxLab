...
import './select-sharp-edges.js?v=0.36.18.114';
import './select-vertex-classification.js?v=0.36.18.114';

// BoxLab v0.36.18.114 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.114',sync};
