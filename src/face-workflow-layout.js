...
import './release-version.js?v=0.36.18.157';

// BoxLab v0.36.18.157 — rendered Vertex picking + Add-vertex Loop promotion.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.157',sync};
