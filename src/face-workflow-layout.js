...
import './release-version.js?v=0.36.18.148';

// BoxLab v0.36.18.148 — Face workflow layout polish + persistent Add Vertex release advance.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.148',sync};
