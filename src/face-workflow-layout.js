...
import './select-vertex-valence.js?v=0.36.18.126';
import './select-quads.js?v=0.36.18.124';

// BoxLab v0.36.18.126 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.126',sync};
