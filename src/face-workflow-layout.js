...
import './release-version.js?v=0.36.18.164';

// BoxLab v0.36.18.164 — Add preserves the live mesh bridge across Undo snapshots.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.164',sync};
