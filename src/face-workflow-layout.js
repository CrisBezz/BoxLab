...
import './release-version.js?v=0.36.18.161';

// BoxLab v0.36.18.161 — window-owned Vertex Slide + restored logical Loop Cut.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.161',sync};
