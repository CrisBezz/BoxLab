...
import './select-vertex-valence.js?v=0.36.18.122';
import './select-quads.js?v=0.36.18.118';

// BoxLab v0.36.18.122 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.122',sync};
