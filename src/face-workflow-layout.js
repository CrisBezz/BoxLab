...
import './release-version.js?v=0.36.18.158';

// BoxLab v0.36.18.158 — full-rail Vertex Slide + local Add-vertex Loop promotion.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.158',sync};
