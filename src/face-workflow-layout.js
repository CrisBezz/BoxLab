...
import './release-version.js?v=0.36.18.160';

// BoxLab v0.36.18.160 — sticky Vertex Slide + Loop preserves Add verts.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.160',sync};
