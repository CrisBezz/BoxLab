...
import './release-version.js?v=0.36.18.167';

// BoxLab v0.36.18.167 — Add handoff preserves deliberate selection.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.167',sync};
