...
import './subdivide-edges.js?v=0.36.18.97';

// BoxLab v0.36.18.97 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.97',sync};
