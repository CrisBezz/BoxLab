...
import './release-version.js?v=0.36.18.159';

// BoxLab v0.36.18.159 — logical-quad Loop Cut + document-owned Vertex Slide.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.159',sync};
