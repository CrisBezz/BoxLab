...
import './release-version.js?v=0.36.18.152';

// BoxLab v0.36.18.152 — Face workflow layout polish + live-rendered Vertex Lasso release advance.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.152',sync};
