...
import './release-version.js?v=0.36.18.155';

// BoxLab v0.36.18.155 — Vertex Slide fresh-topology fix release advance.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.155',sync};
