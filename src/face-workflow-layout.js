import './build-version.js?v=0.36.18.98';
...
import './subdivide-edges.js?v=0.36.18.98';

// BoxLab v0.36.18.98 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.98',sync};
