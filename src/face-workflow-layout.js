...
import './select-sharp-edges.js?v=0.36.18.116';
import './select-vertex-classification.js?v=0.36.18.115';
import './select-vertex-valence.js?v=0.36.18.118';
import './select-quads.js?v=0.36.18.118';

// BoxLab v0.36.18.118 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.118',sync};
