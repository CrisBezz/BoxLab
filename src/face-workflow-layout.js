...
import './select-boundary-structure.js?v=0.36.18.129';
import './select-vertex-classification.js?v=0.36.18.115';
import './select-vertex-valence.js?v=0.36.18.129';
import './select-quads.js?v=0.36.18.128';

// BoxLab v0.36.18.129 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.129',sync};
