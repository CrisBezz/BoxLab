...
import './release-version.js?v=0.36.18.146';

// BoxLab v0.36.18.146 — Face workflow layout polish + Add Vertex release advance.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.146',sync};
