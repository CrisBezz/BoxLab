...
import './release-version.js?v=0.36.18.169';

// BoxLab v0.36.18.169 — helper mesh is pinned to the rendered cage owner.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.169',sync};
