...
import './release-version.js?v=0.36.18.149.1';

// BoxLab v0.36.18.149.1 — Face workflow layout polish + Add Vertex hotfix release advance.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.149.1',sync};
