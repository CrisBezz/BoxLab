...
import './release-version.js?v=0.36.18.147';

// BoxLab v0.36.18.147 — Face workflow layout polish + Add Vertex edge-hit fix.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.147',sync};
