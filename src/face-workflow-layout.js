...
import './live-mesh-bridge.js?v=0.36.18.168';
import './release-version.js?v=0.36.18.168';

// BoxLab v0.36.18.168 — helper mesh is bound to the live rendered cage owner.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.168',sync};
