...
import './release-version.js?v=0.36.18.156';

// BoxLab v0.36.18.156 — Add-session direct-tool handoff release advance.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.156',sync};
