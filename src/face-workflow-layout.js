...
import './select-vertex-valence.js?v=0.36.18.117';

// BoxLab v0.36.18.117 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.117',sync};
