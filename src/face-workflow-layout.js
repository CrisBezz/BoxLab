...
import './select-sharp-edges.js?v=0.36.18.115';
import './select-vertex-classification.js?v=0.36.18.115';

// BoxLab v0.36.18.115 — Face workflow layout polish + modelling/repair tool loading.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.115',sync};
