...
import './release-version.js?v=0.36.18.154';

// BoxLab v0.36.18.154 — deterministic release-owner startup cleanup only.
...
globalThis.__boxlabFaceWorkflowLayout={version:'0.36.18.154',sync};
