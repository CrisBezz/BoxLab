// BoxLab v0.36.18.115 — non-destructive Edge classification selection.
...
function stampVersion(){
  ...
  if(version)version.textContent='v0.36.18.115';
  document.title='BoxLab v0.36.18.115';
}
...
globalThis.__boxlabSelectSharpEdges={version:'0.36.18.115',inspect,apply};
