...
import('./sequential-through-fallback.js?v=0.36.18.11').catch(error => console.warn('BoxLab sequential Through fallback failed to load', error));
...
import('./object-origin.js?v=0.36.4.0-recovery1').then(() => {
  ...
  if (version) version.textContent = 'v0.36.18.11';
  document.title = 'BoxLab v0.36.18.11';
