...
import('./dissolve-selection-polish.js?v=0.36.18.25').catch(error => console.warn('BoxLab Clean Dissolve polish failed to load', error));
...
import('./object-origin.js?v=0.36.4.0-recovery1').then(() => {
  ...
  if (version) version.textContent = 'v0.36.18.25';
  document.title = 'BoxLab v0.36.18.25';
