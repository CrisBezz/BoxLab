...
import('./instance-foundation.js?v=0.36.19.1').catch(error => console.warn('BoxLab instance foundation failed to load', error));
...
import('./object-origin.js?v=0.36.4.0-recovery1').then(() => {
  ...
  if (version) version.textContent = 'v0.36.19.1';
  document.title = 'BoxLab v0.36.19.1';
