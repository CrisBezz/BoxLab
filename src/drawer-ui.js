...
import('./face-workflow-layout.js?v=0.36.18.174').catch(error => console.warn('BoxLab Face workflow layout failed to load', error));
import('./component-inspect-repair-drawers.js?v=0.36.18.174').catch(error => console.warn('BoxLab component Inspect/Repair drawers failed to load', error));
