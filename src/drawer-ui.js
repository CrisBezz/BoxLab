...
import('./dissolve-selection-polish.js?v=0.36.18.24').catch(error => console.warn('BoxLab Dissolve selection polish failed to load', error));
...
import('./object-origin.js?v=0.36.4.0-recovery1').then(() => {
  ...
  if (version) version.textContent = 'v0.36.18.24';
  document.title = 'BoxLab v0.36.18.24';
