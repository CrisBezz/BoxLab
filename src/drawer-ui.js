...
import('./face-reconstruct.js?v=0.36.18.43').catch(error => console.warn('BoxLab Face Reconstruction failed to load', error));
...
import('./join-selected-coplanar-faces.js?v=0.36.18.70').catch(error => console.warn('BoxLab Join Selected Coplanar Faces failed to load', error));
...
import('./object-origin.js?v=0.36.4.0-recovery1').then(() => {
  ...
  if (version) version.textContent = 'v0.36.18.71';
  document.title = 'BoxLab v0.36.18.71';
