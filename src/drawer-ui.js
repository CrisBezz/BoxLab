...
import('./cross-object-snap.js?v=0.36.18.3').catch(error => console.warn('BoxLab cross-object snap failed to load', error));
...
import('./object-origin.js?v=0.36.4.0-recovery1').then(() => {
  ...
  if (version) version.textContent = 'v0.36.18.3';
  document.title = 'BoxLab v0.36.18.3';
