...
import('./select-loose-vertices.js?v=0.36.18.54').catch(error => console.warn('BoxLab Select Loose Vertices failed to load', error));
...
import('./object-origin.js?v=0.36.4.0-recovery1').then(() => {
  ...
  if (version) version.textContent = 'v0.36.18.54';
  document.title = 'BoxLab v0.36.18.54';
