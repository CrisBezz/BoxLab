...
import('./repeat-face-previous.js?v=0.36.18.82').catch(error => console.warn('BoxLab Repeat Previous Face failed to load', error));
...
import('./object-origin.js?v=0.36.4.0-recovery1').then(() => {
  ...
  if (version) version.textContent = 'v0.36.18.82';
  document.title = 'BoxLab v0.36.18.82';
