...
import('./face-workflow-layout.js?v=0.36.18.146').catch(error => console.warn('BoxLab Face workflow layout failed to load', error));
...
import('./object-origin.js?v=0.36.4.0-recovery1').then(() => {
  ...
  if (version) version.textContent = 'v0.36.18.146';
  document.title = 'BoxLab v0.36.18.146';
