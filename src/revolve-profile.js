...
controls.innerHTML=`
  ...
  <div class="outliner-actions" style="grid-template-columns:repeat(2,1fr)">
    <button id="revolveProfileCancelBtn" type="button">Cancel</button>
...
function addRevolveProfile(){
  const m=manager();if(!m?.addMesh)return null;
