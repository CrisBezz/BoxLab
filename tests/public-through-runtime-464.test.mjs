...
test('464 public shell and manifest identify the same build',()=>{
  assert.equal(version,'0.36.18.464');
  assert.match(index,/BoxLab v0\.36\.18\.464/);
  assert.match(index,/data-release-version="0\.36\.18\.464"/);
});

test('464 loads inward Extrude/Through takeover explicitly',()=>{
  const faceAt=index.indexOf('multi-face-direct.js?v=0.36.18.242');
  const throughAt=index.indexOf('sequential-through-fallback.js?v=0.36.18.464');
