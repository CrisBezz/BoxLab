...
test('360 protected Group transform baseline remains exact',()=>{
  ...
  assert.match(index,/object-management\.js\?v=0\.36\.18\.360/);
  assert.match(index,/drawer-ui\.js\?v=0\.36\.18\.360/);
  assert.match(drawer,/object-management\.js\?v=0\.36\.18\.360/);
